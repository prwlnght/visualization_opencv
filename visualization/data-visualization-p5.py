'''
Visualize a bunch of things, and add or remove things as they happen

copyright @prwl_nght

done:
0. saw some capabilities


todo:
0. run thru till the end of the series
1. save all results in .csv and add an upload .csv page to live show results >> for presentations
2. 
'''
